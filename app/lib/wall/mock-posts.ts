...
// 兩邊都要讀寫同一份文章資料，所以型別／假資料／輔助函式要放在兩邊共同的
// 上層目錄，不能再算是「共學牆前台專屬」的東西了。
...
export const mockWallPosts: WallPost[] = [
  ...
  },
  {
    ...
    title: "重現一個經典小遊戲練手感",
    bodyMd:
      "純粹想練習遊戲迴圈跟碰撞判斷的邏輯，用 Canvas 重現了一款經典小遊戲。\n\n## 我原本的程度\n\n上過一學期程式入門課，沒寫過需要處理動畫與碰撞的邏輯。\n\n## 花了多久\n\n一個週末，大約 8 小時。\n\n## 卡在哪、怎麼解決\n\n卡在畫面會閃爍，後來才知道要用 requestAnimationFrame 取代 setInterval 才順。",
  ...
  },
  {
    ...
    bodyMd:
      "串接課程平台的作業列表，自動在截止前一天提醒，避免忘記交作業。\n\n## 我原本的程度\n\n會寫基本的 JavaScript，但沒寫過排程相關的程式。\n\n## 花了多久\n\n大約 1.5 週。\n\n## 卡在哪、怎麼解決\n\n卡在時區換算一直算錯提醒時間，後來統一改用 UTC 儲存才解決。",
  ...
  },
  {
    ...
    bodyMd:
      "把課堂錄音轉成逐字稿後，用 LLM 抓出重點跟待辦事項，複習更有效率。\n\n## 我原本的程度\n\n有基本的 Python 能力，沒處理過語音轉文字的資料。\n\n## 花了多久\n\n大約 2 週，主要是週末時間。\n\n## 卡在哪、怎麼解決\n\n卡在逐字稿有很多口語贅字影響摘要品質，後來加了一個前處理步驟過濾掉才改善。",
    coverUrl: "",
  ...
  },
  {
    ...
    bodyMd:
      "整理自己學習遞迴時的心得，從看不懂、硬背、到真正理解的過程。\n\n## 我原本的程度\n\n完全不懂遞迴，看到程式碼會頭暈。\n\n## 花了多久\n\n斷斷續續花了 2 個月才真正理解。\n\n## 卡在哪、怎麼解決\n\n一直卡在不知道遞迴什麼時候會結束，後來用畫圖追蹤呼叫堆疊的方式，才終於想通。",
    coverUrl: "", // 故意留空，測試「無封面圖時顯示提示文字」
  ...
  },
  {
    ...
    bodyMd:
      "整理這週讀書會討論的幾個常見 prompt 設計誤區，附上修正前後的對照範例。\n\n## 我原本的程度\n\n會用 ChatGPT，但沒有系統性想過 prompt 設計的原則。\n\n## 花了多久\n\n讀書會 2 小時 + 整理筆記 1 小時。\n\n## 卡在哪、怎麼解決\n\n卡在不知道怎麼判斷 prompt 是不是「太模糊」，後來用「拆解成步驟」的方式練習才有感。",
  ...
  },
  {
    ...
    bodyMd:
      "這週讀書會聚焦在 RAG 的資料前處理環節，整理常見的切塊策略跟踩雷點。\n\n## 我原本的程度\n\n知道 RAG 的基本流程，但沒實際處理過真實文件的切塊。\n\n## 花了多久\n\n讀書會 2 小時 + 自己再讀相關文章 1 小時。\n\n## 卡在哪、怎麼解決\n\n卡在切塊大小抓不準，太大檢索不準、太小失去上下文，後來抓中間值搭配重疊視窗才改善。",
  ...
  },
  {
    ...
    bodyMd:
      "整理讀書會討論的幾種 LLM 輸出評估方法，從人工評分到自動化指標都有涵蓋。\n\n## 我原本的程度\n\n知道要評估輸出品質，但不知道有哪些具體的做法可以參考。\n\n## 花了多久\n\n讀書會 2 小時。\n\n## 卡在哪、怎麼解決\n\n卡在自動化指標跟實際體感常常對不上，後來理解要搭配少量人工抽樣才踏實。",
